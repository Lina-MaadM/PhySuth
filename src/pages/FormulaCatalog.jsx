...
function FormulaCatalog() {
  return (
    // Container หลัก
    <div className="px-4 lg:px-8 py-8 space-y-12 max-w-6xl mx-auto">
        ...
        return (
          <div key={topic.topic} className="space-y-8">
            ...
            {topic.datasets
              ...
              .map((dataItem) => (
                <section key={dataItem.subtopic} className="space-y-4">
                  <h2 className="text-lg font-semibold">{dataItem.subtopic}</h2>
